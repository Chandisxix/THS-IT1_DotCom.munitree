...
<body>
    <section id="content_login" class="scroller_login" style="width: 100%;height: 100%;">
        <form class="border rounded border-dark" id="form_login" action="" method="POST" style="opacity: 0.95;height: 100%;max-width: none;width: 500px;background-color: rgb(30,40,51);margin-right: auto;margin-left: auto;padding-bottom: 0px;padding-top: 0px;padding-right: 40px;padding-left: 40px;">
            ...
            <button class="form-group" id="form_button_bar" onclick="location.href='process.php'" formaction="process.php" name = "submit" type="submit" id="form_button" role="button" style="background-color: rgb(118,255,0);color: rgb(0,0,0);font-family: 'Nature Spirit Rough';font-size: 40px;">Log In</button>
